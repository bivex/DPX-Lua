"""Filesystem source provider adapter for discovering Lua & Luau source files (.lua, .luau)."""
...
class FileSourceProvider(SourceProviderPort):
    """Recursively discovers and reads Lua & Luau source files (.lua, .luau) from disk."""
