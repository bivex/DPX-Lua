"""Console Rich Formatter for Lua & Luau pattern detection findings."""
...
class ConsoleReportFormatter(ReportFormatterPort):
    ...
    def format(self, report: DetectionReport, verbose: bool = False) -> str:
        ...
        # Header Banner
        header = Panel.fit(
            f"[bold white]🌙 DPX-Lua: Metatables, Coroutines, LuaJIT FFI, GameDev (Roblox/Neovim) & GoF 23 (Lua 5.1-5.4 / Luau)[/bold white]\n"
        ...
        console.print(table)
        console.print("\n[bold]📋 Identified Lua Metatable Patterns & GameDev Signals:[/bold]\n")
