"""Application scanning service orchestrating Lua & Luau pattern detection."""
...
class ScanningService(ScannerPort):
    """Coordinates discovering, parsing, rule evaluation, and exporting for Lua & Luau codebases."""
