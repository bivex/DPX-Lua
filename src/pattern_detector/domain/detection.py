"""Detection models and aggregate reporting for Lua & Luau."""
...
@dataclass
class Detection:
    """Individual pattern detection or hazard finding in Lua/Luau."""

    pattern_type: PatternType
    pattern_category: PatternCategory
    target_name: str
    target_kind: str  # "class", "module", "fn", "method", "coroutine", "ffi", "roblox"
    ...
    def summary(self) -> str:
        ...
        return f"Lua architectural pattern: {self.pattern_type.value}"
...
class DetectionReport:
    """Aggregate scan result containing all detections across a Lua/Luau project."""
