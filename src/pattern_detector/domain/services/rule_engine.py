"""Domain service evaluating pattern detection rules on Lua CodeModel."""
...
class RuleEngineService:
    """Evaluates rules against a Lua/Luau CodeModel with confidence thresholding and filtering."""
